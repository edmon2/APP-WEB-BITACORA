...
@section('content')
    <div class="container mt-5">
        ...
        <div class="card-body">
            ...
            <p><strong>Usuario del Estudiante:</strong> {{ $entrega->usuario->name }}</p>
            <p><strong>Nombre del Estudiante:</strong> {{ $entrega->usuario->propietario->nombre_completo }}</p>
            <p><strong>Equipo:</strong> {{ $entrega->equipo->tipo_equipo.' - '.$entrega->equipo->no_serie}}</p>
